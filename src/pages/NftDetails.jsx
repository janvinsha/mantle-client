...
export default function NftDetails() {
  ...
  const ContentTopic = `/mantle-market/0/nft-comment/0x46874FEe5Ac808277559c619c52B295429A32911/proto`;
  ...
  const { nft, loading: nftLoading } = useNft(nftId);

  const { profile } = useProfile(
    nft?.seller || '0x659CE0FC2499E1Fa14d30F5CD88aD058ba490e39'
  );
  let userProfile = profile;
  console.log('THIS IS THE NFT IN THE NFTDETAILS', nft);
  return (
    <StyledNftDetails
      exit="exit"
            ...
            {activeTab == 'Description' ? (
              <div className="descr">
                ...
                <span className="price">
                  <span>Price</span>
                  <h2>
                    {ethers.utils.formatUnits(nft?.price || 10000000, 'ether')}{' '}
                    ETH
                  </h2>
                </span>
                <span className="price">
