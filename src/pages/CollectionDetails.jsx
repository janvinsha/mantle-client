...
import { getNftsOfCollection } from '../utils/contract';
import { useNftOfCollection } from '../hooks/useNftOfCollection';
...
export default function CollectionDetails() {
  ...
  let foundCollection = collection;
  const { nftList } = useNftOfCollection(collectionId);
  let nfts = nftList;
    ...
    >
      <div className="collection">
        ...
        <div className="photo-cont">
          <img
            src={sanitizeIpfsUrl(foundCollection?.banner) || bg}
            className="cover"
            alt="img"
          />
          <span className="dp">
            <img
              src={sanitizeIpfsUrl(foundCollection?.dp) || bg}
              className="cover"
              alt="img"
            />
          </span>
