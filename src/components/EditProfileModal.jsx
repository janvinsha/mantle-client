  ...
  const editProfileHandler = async e => {
    ...
    try {
      ...
      if (dp) {
        ...
        photoUrl = `https://mantle-market.infura-ipfs.io/ipfs/${photo.path}`;
      }
      if (cover) {
        banner = await client.add(cover);
        bannerUrl = `https://mantle-market.infura-ipfs.io/ipfs/${banner.path}`;
      }
      ...
      editProfile({
        banner:
          bannerUrl ||
          user.banner ||
          'https://mantle-market.infura-ipfs.io/ipfs/QmVKDkBnDFHy4kwMtLhwJe1c4TwSAPWoVFuJk6Xajh7mRy/',
        dp:
          photoUrl ||
          user.dp ||
          'https://mantle-market.infura-ipfs.io/ipfs/QmVKDkBnDFHy4kwMtLhwJe1c4TwSAPWoVFuJk6Xajh7mRy/',
